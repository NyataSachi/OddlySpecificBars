package com.drakona.oddlyspecificbars.client;
...
import static net.drakona.oddlyspecificbars.config.ModClientConfig.*;
...
public class StaminaBar {
    ...
    private static final float scale = ModClientConfig.HUD_SCALE.get().floatValue();      // change this to scale bar (1.0 = 100%, 2.0 = 200%, etc.)
    private static final int xOffset = ModClientConfig.HUD_X_OFFSET.get();      // X offset from left
    private static final int yOffset = ModClientConfig.HUD_Y_OFFSET.get();;      // Y offset from bottom
