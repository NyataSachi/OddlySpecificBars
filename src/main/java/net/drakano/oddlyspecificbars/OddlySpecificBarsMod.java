package net.drakano.oddlyspecificbars;
...
@Mod("oddly_specific_bars")
public class OddlySpecificBarsMod {
	public static final Logger LOGGER = LogManager.getLogger(OddlySpecificBarsMod.class);
	public static final String MODID = "oddly_specific_bars";

	public OddlySpecificBarsMod() {
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									OddlySpecificBarsMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			OddlySpecificBarsMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
